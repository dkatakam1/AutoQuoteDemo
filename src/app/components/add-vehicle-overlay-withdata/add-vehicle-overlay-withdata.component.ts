...
@Component({
  selector: 'app-add-vehicle-overlay-withdata',
  templateUrl: './add-vehicle-overlay-withdata.component.html',
  styleUrls: ['./add-vehicle-overlay-withdata.component.css']
})
export class AddVehicleOverlayWithdataComponent implements OnInit {
